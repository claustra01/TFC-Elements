...
public enum TFCEMetal implements RegistryMetal {
    ...
    INVAR(0xFFAAAA9E, Rarity.COMMON, Metal.Tier.TIER_IV, true, false, false),
    CONSTANTAN(0xFFD28874, Rarity.COMMON, Metal.Tier.TIER_IV, true, false, false),
    SIGNALUM(0xFFA13800, Rarity.COMMON, Metal.Tier.TIER_V, true, false, false),
    LUMIUM(0xFFFFE46A, Rarity.COMMON, Metal.Tier.TIER_V, true, false, false),
    ENDERIUM(0xFF007989, Rarity.COMMON, Metal.Tier.TIER_VI, true, false, false),
    ALUMINUM(0xFFD9FBFC, Rarity.COMMON, Metal.Tier.TIER_V, true, false, false),
    URANIUM(0xFF3A6724, Rarity.COMMON, Metal.Tier.TIER_VI, true, false, false),
